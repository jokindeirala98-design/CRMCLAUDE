...
exports.VOLTIS_INFO = void 0;
exports.voltisFullAddress = voltisFullAddress;
exports.voltisPortalBaseUrl = voltisPortalBaseUrl;
exports.voltisPortalUrl = voltisPortalUrl;
/**
...
function voltisFullAddress() {
    const i = exports.VOLTIS_INFO;
...
function voltisPortalBaseUrl() {
    ...
    return exports.VOLTIS_INFO.app_url;
}
/** Construye URL del portal magic link */
function voltisPortalUrl(token) {
    return `${voltisPortalBaseUrl()}${exports.VOLTIS_INFO.portal_path}/${token}`;
}
