    ...
    <div className="px-6 md:px-12 pb-24 md:pb-12">
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 pt-4">
        ...
        <div className="flex-1 min-w-0">
          <PlaceholderSection
            section="Ahorros"
            description="Comparativa de los 3 primeros meses con Voltis frente a tu antigua comercializadora. Sin promesas, solo facturas."
            details={[
              'Pagaste antes vs habrías pagado con Voltis (mismo consumo).',
              'Descomposición transparente: cambio de tarifa · cambio normativo · menor consumo.',
              'Comparativa mes a mes con barras: pago antes / Voltis simulado / Voltis real.',
              'Estimación de los 4 escenarios para gas (S0, S1, S2, S3).',
            ]}
          />
        </div>
      </div>
