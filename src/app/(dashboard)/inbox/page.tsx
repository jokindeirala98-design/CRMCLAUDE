          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-on-surface-variant mt-1">PDF o imágenes. También puedes <span className="text-primary font-medium">pegar (Ctrl+V)</span> desde el portapapeles</p>
              </div>
            </div>
