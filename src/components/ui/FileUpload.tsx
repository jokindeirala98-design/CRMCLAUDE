...
export function FileUpload({
  ...
  return (
    <div className={cn('space-y-1.5', className)}>
      ...
      {hasFile ? (
        <div className="flex items-center gap-3 px-4 py-2.5 bg-success-container/20 rounded-xl border border-success/20">
        ...
        <button
          ...
          className={cn(
            ...
            'border-outline-variant/40 hover:border-secondary/40 hover:bg-secondary/5',
            uploading && 'opacity-50 cursor-not-allowed'
          )}
        >
          {uploading ? (
            <svg className="animate-spin w-4 h-4 text-secondary" viewBox="0 0 24 24">
